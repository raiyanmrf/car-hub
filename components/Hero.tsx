...
const Hero = () => {
  return (
    <section className='flex  lg:flex-row flex-col gap-5 relative z-0 max-w-[1440px] mx-auto'>
      <div className='sm:px-16 px-6 py-4 pt-36 flex-1 md:absolute'>
        <h1 className='2xl:text-[72px] lg:text-[64px] xl:max-w-[600px] md:max-w-[550px] text-[40px] font-extrabold '>
          Find, book, rent a car—quick and super easy!
        </h1>
        <p className='xl:text-[27px] lg:text-[19px] text-[16px] text-stone-700 font-light md:max-w-[380px] xl:max-w-[500px] mt-5'>
      ...
      <div className='   flex justify-end items-end  w-full xl:h-screen'>
        <div className='absolute max-lg:max-w-[520px]'>
          <Image
